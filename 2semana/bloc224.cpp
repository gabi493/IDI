...
//---------------------Triangle------------------
	...
	glRotated(double(-angleMultipleObjects), 0., 1., 0.);	//angleMultipleObjects es un integer
...
void mouseMoved(int x, int y) {
	...
	if (translate) {
		...
		newy = 2. - float(y)*2./tam - 1;	//"2. - " perque el pixel (0,0) esta a dalt a la esquerra
	}
	...
	if (multipleObjects) {
		angleMultipleObjects = float(x - oldx)*360./(tam);
